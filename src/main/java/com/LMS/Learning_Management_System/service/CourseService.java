...
public class CourseService {
    ...
    public CourseService(InstructorRepository instructorRepository, CourseRepository courseRepository, EnrollmentRepository enrollmentRepository, EnrollmentService enrollmentService, NotificationsService notificationsService, SessionAuthService sessionAuthService) {
