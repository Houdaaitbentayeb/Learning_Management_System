...
public class AssignmentServiceTest {
    ...
    public void UploadAssignment_UserNotLoggedIn() {
        ...
        assertEquals("Student must be logged in", exception.getMessage());
}
    ...
    public void gradeAssignment_UserNotLoggedIn(){
        ...
        assertEquals("Instructor must be logged in", exception.getMessage());
    ...
    public void gradeAssignment_NotTheInstructor(){
        when(sessionAuthService.requireUser(request)).thenReturn(instructorUser2);
