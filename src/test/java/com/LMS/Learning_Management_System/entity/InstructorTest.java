...
class InstructorTest {
    ...
    void testToString() {
        ...
        // robuste: on vérifie le contenu sans imposer le format exact
        assertTrue(result.contains("Instructor"), "toString doit contenir le nom de la classe");
        assertTrue(result.contains("1"), "toString doit contenir l'ID (1)");
        assertTrue(result.contains("Ahmed"), "toString doit contenir le prénom");
        assertTrue(result.contains("Hassan"), "toString doit contenir le nom");
    }
