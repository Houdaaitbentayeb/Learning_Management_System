...
class StudentTest {
    ...
    void testToString() {
        ...
        assertTrue(result.contains("Student{"), "toString doit commencer par Student{");
        assertTrue(result.contains("userAccountId=1"), "toString doit contenir l'ID");
        assertTrue(result.contains("firstName='Sara'"), "toString doit contenir le prénom");
        assertTrue(result.contains("lastName='Benali'"), "toString doit contenir le nom");
    }
