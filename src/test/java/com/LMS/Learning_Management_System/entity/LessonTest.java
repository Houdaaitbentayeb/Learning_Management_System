...
class LessonTest {
    ...
    void testToString() {
        ...
        assertTrue(result.contains("lessonId=1"), "toString doit contenir l'ID");
        assertTrue(result.contains("lessonName='Test Lesson'"), "toString doit contenir le nom");
        assertTrue(result.contains("lessonOrder=1"), "toString doit contenir l'ordre");
        assertTrue(result.contains("OTP='123456'"), "toString doit contenir l'OTP");
        assertTrue(result.contains("Lesson{"), "toString doit commencer par Lesson{");
    }
